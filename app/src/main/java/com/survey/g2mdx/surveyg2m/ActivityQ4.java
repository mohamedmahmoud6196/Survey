...
public class ActivityQ4 extends AppCompatActivity implements View.OnClickListener {
    Spinner spinner_out;
    ...
    CheckBox comp1,comp2,comp3,comp4,smoke1,smoke2,compact0;
    CheckBox compact1,compact2,compact3,compact4,compact5;
    CheckBox advop1,advop2,advop3;
    LinearLayout lay_comjoin;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_surv4);
      ...
      /*  smoke1=(CheckBox)findViewById(R.id.smoke1);
       ...
       /* advop1=(CheckBox)findViewById(R.id.advop1);
        ...
        compact0=(CheckBox)findViewById(R.id.compact0);
        compact1=(CheckBox)findViewById(R.id.compact1);
        compact2=(CheckBox)findViewById(R.id.compact2);
        compact3=(CheckBox)findViewById(R.id.compact3);
        compact4=(CheckBox)findViewById(R.id.compact4);


        compact0.setOnClickListener(this);
        ...
        lay_comjoin=(LinearLayout)findViewById(R.id.lay_comjoin);
     ...
     //   lay_advcomp2.setVisibility(View.GONE);
      //  lay_advcomp1.setVisibility(View.GONE);
        lay_comjoin.setVisibility(View.GONE);
      ...
      /* ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(this,
        ...
        RadioGroup rg2 = (RadioGroup) findViewById(R.id.joingr);
      rg2.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
        {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId)
            {
                switch(checkedId)
                {
                    case R.id.joinop1:
                        // TODO Something
                        lay_comjoin.setVisibility(View.VISIBLE);
                        break;
                    case R.id.joinop2:
                        // TODO Something
        ...
        switch (v.getId()) {
            ...
            case R.id.btnReg: {
               ...
               // startActivity(intent);
                ...
                Intent intent = new Intent(getApplicationContext(), GetPicActivity.class);
            ...
            case R.id.compact0: {
                // do something for button 2 click
                if(compact0.isChecked())
                {
                    compact1.setVisibility(View.GONE);
                    compact2.setVisibility(View.GONE);
                    compact3.setVisibility(View.GONE);
                    compact4.setVisibility(View.GONE);
                }else
                {
                    compact1.setVisibility(View.VISIBLE);
                    compact2.setVisibility(View.VISIBLE);
                    compact3.setVisibility(View.VISIBLE);
                    compact4.setVisibility(View.VISIBLE);
                }
                break;
            }
            case R.id.comp2: {
